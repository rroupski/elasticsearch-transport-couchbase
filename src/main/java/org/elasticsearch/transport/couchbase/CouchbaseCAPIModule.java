...
public class CouchbaseCAPIModule extends AbstractModule implements SpawnModules
{
	...
	public CouchbaseCAPIModule(final Settings settings)
	{
	...
	public Iterable<? extends Module> spawnModules()
	{
		return ImmutableList.of(
			Modules.createModule(
				settings.getAsClass("couchbase.type",
					CouchbaseCAPITransportModule.class,
					"org.elasticsearch.couchbase.",
					"CouchbaseCAPITransportModule"),
				settings));
	}
